...
SECRET_KEY = 'django-insecure-%m)3u(+i35s8^fx=ais7ddk1w4(ap4rk6eq7f$p^9feyb=2+(m'
...
LOGIN_URL = '/login' #A esta pagina irá para requerir login antes de poder acceder al inicio
